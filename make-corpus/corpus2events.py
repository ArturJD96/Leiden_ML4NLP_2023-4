...
if __name__ == '__main__':
    ...
    path_indir = pathlib.Path('data/corpus')
    path_outdir = pathlib.Path('data/events')
    # os.makedirs(path_outdir, exist_ok=True) [AJD] commented out
    ...
    plot_hist(
        len_list, 
        os.path.join(path_indir, 'num_tokens.png') # [AJD] was 'path_root'
    )