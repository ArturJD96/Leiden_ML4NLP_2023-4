...
import collections
import pathlib
# [AJD] vectorizes events to words.
...
if __name__ == '__main__':
    # paths
    path_root = pathlib.Path('data') # [AJD] was 'ailab17k_from-scratch_cp'
    ...
    # --- build dictionary --- #
    # all files
    # _eventfiles = _eventfiles[0] if len(eventfiles) > 1 else None
    # _file = open(os.path.join(path_indir, _eventfiles), 'rb')
    # class_keys = pickle.load(_file)[0].keys()
