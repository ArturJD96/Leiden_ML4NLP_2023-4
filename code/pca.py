...
scores = numpy.load(f'data/{PARTS or 'all'}_parts/score_vectors.npy').swapaxes(0,1)
labels = pathlib.Path(f'data/{PARTS or 'all'}_parts/labels.txt').read_text().split('\n')
...
scatter_3d = ax.scatter3D(points_3d[0], points_3d[1], points_3d[2])
